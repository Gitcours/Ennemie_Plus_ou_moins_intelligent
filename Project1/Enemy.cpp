...
Enemy::Enemy(float Spawnx, float Spawny, float radius, int hp) : Entity(Spawnx, Spawny, sf::Color::Green, hp), currentPathIndex(0), detectionRadius(radius), pathfindlastpos(0, 0) {
